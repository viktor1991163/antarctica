...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_burger_js__WEBPACK_IMPORTED_MODULE_2__["initBurger"])();
  Object(_modules_map_js__WEBPACK_IMPORTED_MODULE_1__["initMap"])();
...
var initBurger = function initBurger() {
  var siteList = document.querySelector('.main-nav__list--header');
  var button = document.querySelector('.main-nav__toggle');
  var header = document.querySelector('.main-header');
  var logoIcon = document.querySelector('.logo-link__icon--header');
  var overlay = document.querySelector('.overlay');
  var mainNavLinks = document.querySelectorAll('.main-nav__link--header');
  ...
  mainNavLinks.forEach(function (e) {
...
var initMap = function initMap() {
  if (window.ymaps) {
    ...
    ymaps.ready(function () {
      ...
      var myPlacemarkWithContent = new ymaps.Placemark([59.93758158614174, 30.322760541927888], {
